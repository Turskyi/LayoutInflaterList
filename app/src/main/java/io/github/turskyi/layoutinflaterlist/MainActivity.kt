package io.github.turskyi.layoutinflaterlist
...
class MainActivity : Activity() {
    var name = arrayOf("Иван", "Марья", "Петр", "Антон", "Даша", "Борис",
            "Костя", "Игорь")
    var position = arrayOf("Программер", "Бухгалтер", "Программер",
            "Программер", "Бухгалтер", "Директор", "Программер", "Охранник")
    var salary = intArrayOf(13000, 10000, 13000, 13000, 10000, 15000, 13000, 8000)
